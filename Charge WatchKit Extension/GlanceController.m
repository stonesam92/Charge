...
@property (weak, nonatomic) IBOutlet WKInterfaceImage *batteryPercentLabel;
...
- (void)updateInterfaceForBatteryLevel:(int)batteryLevel {
    if (batteryLevel != self.currentBatteryLevel) {
        ...
        [self.batteryPercentLabel setImageNamed:[NSString stringWithFormat:@"percent-%d", batteryLevel]];
    }
}
